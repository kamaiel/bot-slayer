...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.MyBrainStage2"; //class given by name; is supposed to extends robotsimulator.Brain
  public static final String teamAMainBotAvatar = "avatars/NicePng_spaceship-png_138961.png"; //path relative to location of ant build.xml file
  ...
  public static final String teamASecondaryBotBrainClassName = "binbrain.BinBrainStage6"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamBMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamBMainBot1InitX = 1500, //1 unit = 1mm, coordinate of central point
                             teamBMainBot1InitY = 1000, //1 unit = 1mm, coordinate of central point
                             teamBMainBot1InitHeading = WEST, //clockwise trigonometric unit, according to screen pixel coordinate reference
                             teamBMainBot2InitX = 1500, //1 unit = 1mm, coordinate of central point
                             ...
                             teamBMainBot3InitX = 1500, //1 unit = 1mm, coordinate of central point
                             teamBMainBot3InitY = 1000, //1 unit = 1mm, coordinate of central point
  ...
  public static final double teamBSecondaryBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamBSecondaryBot1InitX = 1500, //1 unit = 1mm, coordinate of central point
                             teamBSecondaryBot1InitY = 1000, //1 unit = 1mm, coordinate of central point
                             teamBSecondaryBot1InitHeading = WEST, //clockwise trigonometric unit, according to screen pixel coordinate reference
                             teamBSecondaryBot2InitX = 1500, //1 unit = 1mm, coordinate of central point
                             teamBSecondaryBot2InitY = 1000, //1 unit = 1mm, coordinate of central point
